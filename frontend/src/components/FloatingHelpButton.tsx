              ...
              <div className="grid gap-3">
                <Button variant="outline" className="w-full justify-start gap-3 h-12" disabled>
                  ...
                  <div className="text-left">
                    <p className="font-medium text-gray-500">Create New Ticket</p>
                    <p className="text-xs text-muted-foreground">Help desk temporarily unavailable</p>
                  </div>
                </Button>
                ...
                <Button variant="outline" className="w-full justify-start gap-3 h-12" disabled>
                  ...
                  <div className="text-left">
                    <p className="font-medium text-gray-500">My Tickets</p>
                    <p className="text-xs text-muted-foreground">Help desk temporarily unavailable</p>
                  </div>
                </Button>
                ...
                <Button variant="outline" className="w-full justify-start gap-3 h-12" disabled>
                  ...
                  <div className="text-left">
                    <p className="font-medium text-gray-500">Knowledge Base</p>
                    <p className="text-xs text-muted-foreground">Help desk temporarily unavailable</p>
                  </div>
                </Button>
              </div>
